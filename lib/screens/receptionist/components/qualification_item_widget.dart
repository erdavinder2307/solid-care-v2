...
class QualificationItemWidget extends StatelessWidget {
  ...
  const QualificationItemWidget({Key? key, required this.data, required this.onEdit}) : super(key: key);
        ...
        children: [
          Row(
            ...
            children: [
              ...
              ic_edit.iconImage(size: 22, color: context.iconColor, fit: BoxFit.cover).onTap(onEdit)
            ],
          ),
          2.height,
          Row(
