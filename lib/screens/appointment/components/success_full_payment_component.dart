...
class SuccessFullPaymentComponent extends StatefulWidget {
  ...
  @override
  State<SuccessFullPaymentComponent> createState() =>
      _SuccessFullPaymentComponentState();
}

class _SuccessFullPaymentComponentState
    extends State<SuccessFullPaymentComponent> {
  @override
  void initState() {
    super.initState();
    init();
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        SizedBox(
          child: Lottie.asset(
            widget.paymentStatus.validate()
                ? ic_successFullPayment
                : ic_failedPayment,
            fit: BoxFit.cover,
          ),
        ).center(),
