...
class _PatientListComponentState extends State<PatientListComponent> {
  ...
  bool get showEdit {
    return isVisible(SharedPreferenceKey.solidCarePatientEditKey);
  }

  bool get showDelete {
    return isVisible(SharedPreferenceKey.solidCarePatientDeleteKey);
  }
                  ...
                  Column(
                    ...
                    children: [
                      Text(
                          ...
                          maxLines: 2),
                      8.height,
                      if (widget.patientData!.mobileNumber
                          .validate()
                          .isNotEmpty)
                        TextIcon(
              ...
              Positioned(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (isVisible(
                        SharedPreferenceKey.solidCarePatientEncounterListKey))
