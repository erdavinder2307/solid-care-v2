...
import 'package:solidcare/screens/doctor/screens/add_bill_item_screen.dart';
...
class _GenerateBillScreenState extends State<GenerateBillScreen> {
  ...
  void getTotal() {
    ...
    billItemData.forEach((element) {
      payableText += (element.price.validate().toDouble() *
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Spacer(),
                      Text(
                          "${appStore.currencyPrefix.validate(value: appStore.currency.validate(value: ''))}${totalCont.text.toString()}${appStore.currencyPostfix.validate(value: '')}",
                          style: boldTextStyle(),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Spacer(),
                      Text(
                          "${appStore.currencyPrefix.validate(value: appStore.currency.validate(value: ''))}${payableCont.text.toString()}${appStore.currencyPostfix.validate(value: '')}",
                          style: boldTextStyle(),
                          textAlign: TextAlign.right),
                    ],
                  ),
