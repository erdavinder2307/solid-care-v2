...
Future<DoctorSessionModel> getDoctorSessionDataAPI({String? clinicId = ''}) async {
  ...
  return DoctorSessionModel.fromJson(await (handleResponse(await buildHttpResponse('kivicare/api/v1/setting/get-doctor-clinic-session?clinic_id=${clinicId != null ? clinicId : ''}'))));
}
