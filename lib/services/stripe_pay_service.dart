...
import 'package:solidcare/model/stripe_pay_model.dart';
...
class StripeServices {
  ...
  void stripePay() async {
    ...
    request.bodyFields = {
      'amount':
          '${(appointmentBookingData.orderData!.amount.validate() * 100).toInt()}',
            ...
            if (response.statusCode.isSuccessful()) {
              ...
              SetupPaymentSheetParameters setupPaymentSheetParameters =
                ...
                appearance: PaymentSheetAppearance(
                    colors:
                        PaymentSheetAppearanceColors(primary: appPrimaryColor)),
