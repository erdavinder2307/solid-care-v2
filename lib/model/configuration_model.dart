...
class ConfigurationModel {
  ...
  bool? isSolidCareProOnName;
  bool? isSolidCareGoogleMeetActive;
  String? telemedType;
  ...
  ConfigurationModel({
    ...
    this.isSolidCareProOnName,
    this.isSolidCareGoogleMeetActive,
    this.telemedType,
  ...
  ConfigurationModel.fromJson(dynamic json) {
    ...
    permissions = json['permissions'] != null
        ? UserPermission.fromJson(json['permissions'])
        : null;
    isRazorPayOn = json['is_RazorPay_On'];
    isWoocommerceOn = json['is_Woocommerce_On'];
    isTeleMedActive = json['isTeleMedActive'];
    isSolidCareProOnName = json['isSolidCareProOnName'];
    isSolidCareGoogleMeetActive = json['isSolidCareGooglemeetActive'];
    ...
    restrictAppointment = json['restrict_appointment'] != null
        ? RestrictAppointment.fromJson(json['restrict_appointment'])
        : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    map['isSolidCareProOnName'] = isSolidCareProOnName;
    map['isSolidCareGooglemeetActive'] = isSolidCareGoogleMeetActive;
